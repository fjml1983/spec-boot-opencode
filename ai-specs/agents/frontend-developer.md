...
- After you finish the work, MUST create `docs/agent_outputs/{feature_name}-frontend-plan.md` so others can get full context of your proposed implementation
